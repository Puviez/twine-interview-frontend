    ...
    <div>
      <CounterContext.Provider value={{counters, setCounters}}>
        {counters.map((counter) => {
          return <Counter key={counter.id} id={counter.id} counterName={counter.counterName} counterValue={counter.counterValue} updateCounter={updateCounter} removeCounter={removeCounter}/>
        })}
